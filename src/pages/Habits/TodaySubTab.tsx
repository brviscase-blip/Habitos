        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[2000] flex items-end md:items-center justify-center md:p-4">
            ...
            <motion.div 
              ...
              className="relative w-full h-full md:h-auto md:max-w-md bg-gh-bg md:border md:border-gh-border md:rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.7)] overflow-hidden flex flex-col"
            >
              ...
              <div className="p-4 md:p-6 flex-1 overflow-y-auto custom-scrollbar bg-gradient-to-b from-transparent to-gh-bg md:max-h-[80vh]">
                <form onSubmit={handleCreateTask} className="space-y-5 md:space-y-6 pb-20 md:pb-0">
                  {/* 1. Nome Tarefa */}
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <div className="flex items-center justify-between bg-gh-card border border-gh-border rounded-xl p-2 md:p-2.5 shadow-inner">
                      ...
                      <div className="flex flex-col items-center">
                        <span className="text-xl md:text-2xl font-black text-white leading-none">{taskExecutions}</span>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <Button 
                      type="submit" 
                      className="flex-[2] font-black uppercase tracking-[0.15em] text-xs bg-gh-blue hover:bg-gh-blue/80 text-white shadow-[0_10px_30px_rgba(47,129,247,0.3)] h-11 rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98]"
                    >
                      Criar Tarefa
                    </Button>
                  </div>
